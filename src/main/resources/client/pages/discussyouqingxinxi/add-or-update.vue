	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussyouqingxinxi`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discussyouqingxinxi`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discussyouqingxinxi`, this.ruleForm);
						}else{
							await this.$api.add(`discussyouqingxinxi`, this.ruleForm);
						}
						uni.setStorageSync('discussyouqingxinxiCleanType',true);
