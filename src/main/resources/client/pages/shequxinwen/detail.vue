	...
	<view class="content">
		<view class="container" :style='{"width":"100%","padding":"0px","position":"relative","background":"#ffffff","height":"auto"}'>
				...
				<view :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}' class="detail-list-item title">
					<view :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#5fb959","textAlign":"right"}' class="lable">标题：</view>
					<view :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}' class="text">{{detail.biaoti}}</view>
				</view>
				...
				<view class="detail-list-item" :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#5fb959","textAlign":"right"}'>类型：</view>
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}'>{{detail.leixing}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}'>
					...
					<view  class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}'>{{detail.faburiqi}}</view>
				</view>
				<view class="detail-list-item" :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}'>
				...
				<view class="detail-list-item" :style='{"margin":"16rpx 0 16rpx 0","borderColor":"#f0b8dd","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"dotted","height":"auto"}'>
					<view class="lable" :style='{"width":"auto","padding":"0 20rpx 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#5fb959","textAlign":"right"}'>简介</view>
					<view class="text" :style='{"padding":"0px 0 0 0","margin":"0 0 0 0","lineHeight":"60rpx","fontSize":"28rpx","color":"#666666","flex":"1"}'>{{detail.jianjie}}</view>
				</view>
				...
				<view class="detail-list-item rich" :style='{"margin":"24rpx 0 44rpx 0","borderColor":"#cccccc","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 0px 0","background":"#ffffff","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 24rpx 0 24rpx","margin":"0 0 0px","borderColor":"#f0b8dd","color":"#d84fa9","textAlign":"left","background":"#fff","borderWidth":"0 0 2rpx 0","width":"100%","lineHeight":"60rpx","fontSize":"32rpx","borderStyle":"dotted","fontWeight":"500"}'>内容</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			this.getStoreup();
			let cleanType = uni.getStorageSync('discussshequxinwenCleanType')
			if(cleanType){
				uni.removeStorageSync('discussshequxinwenCleanType')
				this.mescroll.num = 1
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('shequxinwen', this.id);
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','shequxinwen');
					...
					uni.showModal({
						...
						success: async function(res) {
							if (res.confirm) {
								...
								await _this.$api.update('shequxinwen',_this.detail)
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				...
				uni.setStorageSync('crossTable','shequxinwen');
			...
			async init(){
				...
				let res = await this.$api.info('shequxinwen', this.id);
				this.detail = res.data;
				// 轮播图片
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussshequxinwen', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			async onCommentTap() {
				...
				this.$utils.jump(`../discussshequxinwen/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
				if(!this.user){
